name			= "DIS-Exporter";				// Name of your mod
...
actionName		= "GitHub";
action			= "https://github.com/DIS-Wolv/DIS-Exporter";			// Website URL, that can be accessed from the expansions menu
overview		= "Node Exporter for DIS";	// Supports structured text
